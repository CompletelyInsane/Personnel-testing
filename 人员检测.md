...
![](vx_images/250983010249582.png =266x)
![](vx_images/492624309249584.png =266x)
![](vx_images/27564409237451.png =266x)
...
![](vx_images/453865516257988.png =600x)
双击安装 Arduino 
...
![](vx_images/123455916231517.png =446x)
转到红色框中的文件夹。
![](vx_images/287015916234021.png =573x)
在 Arduino 文件夹中创建一个新的“硬件”文件夹。如果已经有一个“硬件”文件夹，则无需创建新文件夹。
![](vx_images/410965916242968.png =431x)
...
![](vx_images/568370715249581.png =400x)
## 4.显示效果
![](vx_images/333781516237448.png =300x)
![](vx_images/155761816250283.png =300x)