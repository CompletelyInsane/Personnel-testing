...
![](vx_images/492624309249584.png =330x)
![](vx_images/27564409237451.png =330x)
...
## 1.TF-Luna 简要说明
   ![](vx_images/470135116231067.png =650x)
![](vx_images/2055216249493.png =650x)
相关链接：https://blog.csdn.net/zoran_wu/article/details/121850480
## 2.WiFi LoRa 32 (V3)
![](vx_images/320405316237360.png =209x)![](vx_images/396065316257526.png =207x)
![](vx_images/508565316250195.png =540x)
![](vx_images/52035416246750.png =1000x)
官方资料请参考 :
...
![](vx_images/453865516257988.png =465x)
双击安装 Arduino 
![](vx_images/514255616254307.png =465x)
![](vx_images/27085716247853.png =469x)

## 2.安装芯片包和查看例程
### 通过本地文件的方式
下载开发环境：https://resource.heltec.cn/download/tools/WiFi_Kit_series.zip
打开 Arduino IDE，然后单击 -> FilePeferences
![](vx_images/123455916231517.png =469x)
转到红色框中的文件夹。
![](vx_images/287015916234021.png =469x)
在 Arduino 文件夹中创建一个新的“硬件”文件夹。如果已经有一个“硬件”文件夹，则无需创建新文件夹。
![](vx_images/410965916242968.png =469x)
转到“硬件”文件夹并将“WiFi_Kit_series”提取到此文件夹中。
![](vx_images/585745916235853.png =514x)
进入“WiFi_Kit_series”文件夹，参考下图确认红框中的路径是否正确。
![](vx_images/168120017236462.png =469x)
...
设计方案为平行等高横向地安装两个雷达：
![](vx_images/568370715249581.png =400x)
行人与两雷达相对位置的四个状态：
![](vx_images//345844516231150.png =605x)
识别两个动作
![](vx_images/486684516249576.png =605x)
增加 ：10->11->01  
减小： 01->11->10   
完成动作则进行增减
...
![](vx_images/525300216249581.png =570x)
L1、L2跟随通道宽度实际距离变动。
![](vx_images/413683016246838.png =420x)
:::
...
**雷达硬件接线图：**
![](vx_images/227323915231155.png =614x)
...
```
![屏幕显示效果](vx_images//86620317237444.png =356x)
...
>1. 下载工程
![](vx_images/286393711231161.png =603x)
>2. 下载解压，进入目录 
![](vx_images/469604011249587.png =603x)
>3. 双击打开工程
![](vx_images/218994111237454.png =603x)
>4. 在设备管理器中查看对应端口
...
## 2.接线图
![](vx_images//359045615231151.png =650x)
## 3.安装方式
横向平行安装两个雷达，雷达的间距可以根据具体情况调整，合适的间距能过滤掉干扰。
![](vx_images/568370715249581.png =400x)
## 4.显示效果
![](vx_images/333781516237448.png =400x)
![](vx_images/155761816250283.png =400x)